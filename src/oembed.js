 ...
 * 
 * @param {String} url - the url you want to embed
 * @param {Object} requestParams - an object that contains additional request
 *                parameters (such as maxwidth, maxheight)
 * @param {Function} callback - a callback function(err, info)
 */
